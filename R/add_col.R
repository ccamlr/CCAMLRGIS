...
#' 
#' #With custom colors - here from blue to red
#' MyCols=add_col(MyPoints$Nfishes,cols=c('blue','red')) 
#' plot(st_geometry(MyPoints),pch=21,bg=MyCols$varcol,cex=2)
#' 
#' #With custom colors and fewer classes
...
#' plot(st_geometry(MyGrid),col=Gridcol$varcol) #Use the colors generated by add_col
