...
par(mai=c(0.55,0.7,0.2,0.45))
#plot Coastline
plot(Coast,col='grey',lwd=0.1)
#Add reference grid
add_RefGrid(bb=bbox(Coast),ResLat=10,ResLon=20,LabLon=-40,fontsize=0.4,lwd=0.5)
#add axes and labels
...
```{r fig.align="center",out.width="100%",message=F,dpi=200,eval=T,fig.height=1}
...
```{r fig.align="center",out.width="100%",message=F,dpi=200,eval=T,fig.height=2}
...
```{r fig.align="center",out.width="100%",message=F,dpi=200,eval=T,fig.height=1.5}
...
```{r fig.align="center",out.width="100%",message=F,dpi=200,eval=T,fig.height=3}
...
par(mai=c(0.2,0.05,0.1,0.1)) #set plot margins as c(bottom, left, top, right)
...
```{r fig.align="center",out.width="100%",message=F,dpi=200,eval=T,fig.height=5}
...
#Prepare layout for 2 sub-plots
par(mfrow=c(2,1))
par(mai=c(0.2,0.2,0.01,0.01)) #set plot margins as c(bottom, left, top, right)
#Plot Catch vs Depth
XL=c(-4500,-2000) #Set plot x-axis limits
YL=c(10,90)       #Set plot y-axis limits
...
text(XL[1]-250,mean(YL),'Catch',cex=0.5,xpd=T,srt=90)
...
par(mai=c(0.01,0.01,0.01,0.01)) #set plot margins as c(bottom, left, top, right)
