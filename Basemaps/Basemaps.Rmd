...
Each of the following sections contain code to produce maps corresponding to the areas shown in the [Fishery Reports]. To produce any of these maps, one must download the entire *Basemaps* folder and run the code given in the *Initialization* section first.
