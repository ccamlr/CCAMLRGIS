...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.21.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.22.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.22b.png")
```
...
This function creates hashed lines to fill a polygon. Its output is a spatial object in your environment, to be added to your plot.
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.23.png")
```
...
This function creates an ellipse. Its output is a spatial object in your environment, to be added to your plot.
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.24.png")
```
...
This function creates circular arrows. Its output is a spatial object in your environment, to be added to your plot.
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.25.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.26.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.27.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.28.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.29.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig2.30.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig3.1.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig4.1.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig4.2.png")
```
...
From an input raster and chosen cuts (classes), turns areas between contours into polygons. An input polygon may optionally be given to constrain boundaries. The accuracy is dependent on the resolution of the raster (e.g., see *load_Bathy()* to get high resolution bathymetry). if *Grp* is set to TRUE (slower), contour polygons that touch each other are identified and grouped (a Grp column is added to the object). This can be used, for example, to identify seamounts that are constituted of several isobaths (see example 2 below).
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig4.3.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.1.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.2.png")
```
...
*add_col()* generates colors for a variable of interest as well as a set of color classes and colors to be used as inputs to the *add_Cscale()* function. Colors and color classes may be generated automatically or customized, depending on the intended appearance. Knowing the names of colors in R would be useful here (<https://sites.stat.columbia.edu/tzheng/files/Rcolor.pdf>).
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.3.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.4.png")
```
...
A simple way to quickly add a legend, is by using the base *legend()* function:
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.5.png")
```

<br>

For a more complete and customizable approach, use the *add_Legend()* function. It uses the bounding box of your plot and lists of parameters as inputs. The help given in the R package contains all the details:
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.6.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.7.png")
```
...
Due to the retirement of some packages that the CCAMLRGIS package used to rely on, since CCAMLRGIS V4.0.0 the package relies on the [sf package](https://CRAN.R-project.org/package=sf), users may need to familiarize themselves with it. Using *sf* objects has advantages such as the ability to use [Tidyverse methods](https://r-spatial.github.io/sf/reference/tidyverse.html). Further, additional [plotting methods](https://r-spatial.github.io/sf/articles/sf5.html) are available, some of which are described in this section.
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.8.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.9.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.10.png")
```
...
```
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.11.png")
```
...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F}
include_graphics("ReadMeFigs/ReadMe_Fig5.12.png")
```
